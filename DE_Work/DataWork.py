...
# save the new file Systembook
 
Systembook.to_csv("Systembook_Clean_New.csv", index=False)

# save the new file customer
 
Customer.to_csv("Customer_Clean_New.csv", index=False)